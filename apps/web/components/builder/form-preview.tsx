    ...
    <section className="rounded-[var(--radius-card)] border border-[var(--color-hairline-soft)] bg-[var(--color-card)] p-4 shadow-[var(--shadow-card)]">
      ...
      <div className={mode === "mobile" ? "mx-auto max-w-[390px]" : ""}>
        <div className="rounded-[var(--radius-hero)] border border-[var(--color-hairline-soft)] bg-[var(--color-canvas)] p-4">
          <div className="rounded-[var(--radius-card)] bg-[var(--color-card)] p-5 shadow-[var(--shadow-card)]">
            <h3 className="text-2xl font-bold leading-tight text-[var(--color-ink)]">
              {title || "Untitled form"}
            </h3>
...
function renderControl(field: BuilderField) {
  ...
  if (field.type === "dropdown") {
    return (
      <select className="h-11 rounded-[var(--radius-button)] border border-[var(--color-hairline-soft)] bg-[var(--color-card)] px-3 text-sm text-[var(--color-charcoal)]">
  ...
  if (field.type === "url") {
    return (
      <input
        className="h-11 rounded-[var(--radius-button)] border border-[var(--color-hairline-soft)] bg-[var(--color-card)] px-3 text-sm text-[var(--color-charcoal)]"
        placeholder="https://"
        type="url"
      />
    )
...
function RichTextPreview() {
  ...
  return (
    <div className="min-h-24 rounded-[var(--radius-button)] border border-[var(--color-hairline-soft)] bg-[var(--color-card)] px-3 py-2 text-sm text-[var(--color-slate)]">
